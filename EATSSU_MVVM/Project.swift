...
let eatSSUSettings: Settings = .settings(
  ...
  configurations: [
  .debug(name: "Debug", xcconfig: "EATSSU_MVVM/Resources/Debug.xcconfig"),
  .release(name: "Release", xcconfig: "EATSSU_MVVM/Resources/Release.xcconfig"),
  ]
)
...
let project = Project(
    ...
    targets: [
        .target(
            ...
            sources: ["EATSSU_MVVM/Sources/**"],
            resources: ["EATSSU_MVVM/Resources/**"],
            entitlements: "EATSSU_MVVM/Resources/EatSSU-iOS.entitlements",
            dependencies: [
